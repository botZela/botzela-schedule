        ...
        <div class="header">
            ...
            <p>
                ...
                <b>
                    {move || {
                        format!(
                            "Emploi du Temps de la période 1 du Semestre 3 - {} Année", header_args.get()
                            .year
                        )
                    }} <br/> {move || {
                        format!(
                            "Filiere: {} |_| Groupe : {} |_| Week : {}", header_args.get().filiere,
                            header_args.get().groupe, header_args.get().week
                        )
                    }}
